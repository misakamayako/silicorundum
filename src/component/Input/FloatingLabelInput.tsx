...
export default function FloatingLabelInput(props: Props) {
	return (
		<label
			className={
				"relative block rounded-md border border-gray-200 shadow-sm " +
		...
		>
			<input
				type="text"
				className={
					"peer border-none bg-transparent placeholder-transparent " +
			...
			{props.label ? (
				<span
					className={
						"pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 bg-white p-0.5 text-xs" +
